...
{
*/
	if (!commentlength($_GET["content"], 50, 5000)) //check length of sent comment
	{
	printf ("Error: Comment is not long enough. Must be over 50 characters, and less than 5000.");
	exit(); //stop script
	}
else
{
